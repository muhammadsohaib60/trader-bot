...
class StockData:     # class to encapsulate price data and indicators, and allow multi bar timing
    ...
    def calculate_average_price(self):
        avg_price = self.df['close'].tail(3).mean()
        #print(self.df)
        #avg_price = self.df.last(1).close
        return avg_price
    def time(self):
        ...
        return value
    def open(self):
        value = self.df.iloc[-1]['open']
        return value
    def high(self):
        value = self.df.iloc[-1]['high']
        return value
    def low(self):
        value = self.df.iloc[-1]['low']
        return value
    def close(self):
        value = self.df.iloc[-1]['close']
        return value
    def vwap(self):
        value = self.df.iloc[-1]['vwap']
        return value
    def volume(self):
        value = self.df.iloc[-1]['volume']
        return value
    def SMA3(self):
        value = self.df.iloc[-1]['SMA3']
        return value
    def SL_SMA3(self):
        value = self.df.iloc[-1]['Sl_SMA3']
        return value
    def SMA14(self):
        value = self.df.iloc[-1]['SMA14']
        return value
    def SL_SMA14(self):
        value = self.df.iloc[-1]['Sl_SMA14']
        return value
    def SMA50(self):
        value = self.df.iloc[-1]['SMA50']
        return value
    def SL_SMA50(self):
        value = self.df.iloc[-1]['Sl_SMA50']
        return value
    def SMA200(self):
        value = self.df.iloc[-1]['SMA200']
        return value
    def SL_SMA200(self):
        value = self.df.iloc[-1]['Sl_SMA200']
        return value

    def BBL_14_2(self):
        value = self.df.iloc[-1]['BBL_14_2']
        return value
    def BBM_14_2(self):
        value = self.df.iloc[-1]['BBM_14_2']
        return value
    def BBU_14_2(self):
        value = self.df.iloc[-1]['BBU_14_2']
        return value
    def BBB_14_2(self):
        value = self.df.iloc[-1]['BBB_14_2']
        return value
    def BBP_14_2(self):
        value = self.df.iloc[-1]['BBP_14_2']
        return value
