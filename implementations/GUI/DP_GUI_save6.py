...
def Chart_Plot_Std(Ticker, df, df5, df15, dfD):
    ...
    fig.add_trace(go.Scatter(x=df.index, y=df.SMA3, mode='lines', name='SMA3', line_color='#ff00ff'), row=1, col=5)
    fig.add_trace(go.Scatter(x=df.index, y=df.SMA14, mode='lines', name='SMA14', line_color='#ff0000'), row=1,  col=5)
    fig.add_trace( go.Scatter(x=df.index, y=df.SMA50, mode='lines', name='SMA50', line_color='#00ff00', line_width=2), row=1, col=5)
    fig.add_trace( go.Scatter(x=df.index, y=df.SMA200, mode='lines', name='SMA200', line_color='#0000ff', line_width=3), row=1, col=5)
    fig.add_trace(go.Scatter(x=df.index, y=df.BBL_14_2, mode='lines', name='BBL_14_2', line=dict(color='#56a6ae', dash='dash')), row=1,col=5)
    fig.add_trace(go.Scatter(x=df.index, y=df.BBU_14_2, mode='lines', name='BBU_14_2', line=dict(color='#56a6ae', dash='dash')), row=1,col=5)
    ...
    fig.add_trace(go.Scatter(x=df5.index, y=df5.SMA3, mode='lines', name='SMA3', line_color='#ff00ff'), row=1,col=4)
    fig.add_trace(go.Scatter(x=df5.index, y=df5.SMA14, mode='lines', name='SMA14', line_color='#ff0000'), row=1, col=4)
    fig.add_trace( go.Scatter(x=df5.index, y=df5.SMA50, mode='lines', name='SMA50', line_color='#00ff00', line_width=2), row=1, col=4)
    fig.add_trace( go.Scatter(x=df5.index, y=df5.SMA200, mode='lines', name='SMA200', line_color='#0000ff', line_width=3), row=1, col=4)
    fig.add_trace(go.Scatter(x=df5.index, y=df5.BBL_14_2, mode='lines', name='BBL_14_2', line=dict(color='#56a6ae', dash='dash')), row=1,  col=4)
    fig.add_trace(go.Scatter(x=df5.index, y=df5.BBU_14_2, mode='lines', name='BBU_14_2', line=dict(color='#56a6ae', dash='dash')), row=1, col=4)
    ...
    fig.add_trace(go.Scatter(x=df15.index, y=df15.SMA3, mode='lines', name='SMA3', line_color='#ff00ff'), row=1,col=3)
    fig.add_trace(go.Scatter(x=df15.index, y=df15.SMA14, mode='lines', name='SMA14', line_color='#ff0000'), row=1, col=3)
    fig.add_trace( go.Scatter(x=df15.index, y=df15.SMA50, mode='lines', name='SMA50', line_color='#00ff00', line_width=2),  row=1, col=3)
    fig.add_trace( go.Scatter(x=df15.index, y=df15.SMA200, mode='lines', name='SMA200', line_color='#0000ff', line_width=3), row=1, col=3)
    fig.add_trace(go.Scatter(x=df15.index, y=df15.BBL_14_2, mode='lines', name='BBL_14_2', line=dict(color='#56a6ae', dash='dash')), row=1, col=3)
    fig.add_trace(go.Scatter(x=df15.index, y=df15.BBU_14_2, mode='lines', name='BBU_14_2', line=dict(color='#56a6ae', dash='dash')), row=1,  col=3)
...
def Chart_Plot_HistoAnalysis(Ticker, df, df5, df15, dfD):
    # Create subplots
    fig = make_subplots(rows=2, cols=5, subplot_titles=['CONTROLS:', '1 Day', '15 Minute', '5 Minute', '1 Minute',
                                                        ' ', '1 Day Volume', '15 Min Volume', '5 Min Volume',
                                                        '1 Min Volume'],
                        row_width=[0.2, 0.7], shared_yaxes=False, vertical_spacing=0.15,
                        horizontal_spacing=0.02, print_grid=False, )
    ...
    # 1 Min Update the time selected zoom
    start_time_1 = datetime.combine(datetime.today(), time(7, 30))
    end_time_1 = datetime.combine(datetime.today(), time(14, 0))
    last_day = df.index[-1].date()
    start_datetime_1 = datetime.combine(last_day, start_time_1.time())
    end_datetime_1 = datetime.combine(last_day, end_time_1.time())

    # 5 Min Update the time selected zoom to last day view
    start_time_5 = datetime.combine(datetime.today(), time(7, 30))
    end_time_5 = datetime.combine(datetime.today(), time(14, 0))
    last_day = df.index[-1].date()
    start_datetime_5 = datetime.combine(last_day, start_time_5.time())
    end_datetime_5 = datetime.combine(last_day, end_time_5.time())

    # 15 Min Update the time selected zoom to last day view
    start_time_15 = datetime.combine(datetime.today(), time(7, 30))
    end_time_15 = datetime.combine(datetime.today(), time(14, 0))
    last_day = df.index[-1].date()
    start_datetime_15 = datetime.combine(last_day, start_time_15.time())
    end_datetime_15 = datetime.combine(last_day, end_time_15.time())
    ...
    #Dyn_Ymin = df[start_datetime_1].low - 1
    #Dyn_Ymax = df[end_datetime_1].high + 1


    # print(Dyn_Ymin.values[0])
    #Dyn_Ymin_1min = math.ceil(Dyn_Ymin_1min.values[0] * 0.98)
    #Dyn_Ymax_1min = math.floor(Dyn_Ymax.values[0] * 1.02)
    #Dyn_Ymin_5min = math.ceil(Dyn_Ymin.values[0] * 0.98)
    #Dyn_Ymax_5min = math.floor(Dyn_Ymax.values[0] * 1.02)
    #Dyn_Ymin_15min = math.ceil(Dyn_Ymin.values[0] * 0.95)
    ...
    fig.update_yaxes(range=[Dyn_Ymin, Dyn_Ymax], row=1, col=3)
    fig.update_yaxes(range=[Dyn_Ymin, Dyn_Ymax], row=1, col=4)
    fig.update_yaxes(range=[Dyn_Ymin, Dyn_Ymax], row=1, col=5)
