...
def Chart_Plot_Std(Ticker, df, df5, df15, dfD):
    ...
    fig = make_subplots(rows=2, cols=4, subplot_titles=[ '1 Day', '15 Minute', '5 Minute', '1 Minute',
                         '', '', '', ''],
                        row_width=[0.2, 0.75], shared_yaxes=False, vertical_spacing=0.2,
    ...
    fig.update_yaxes(color='#000000', range=[0, 3000000], row=2, col=3)
    fig.update_yaxes(color='#000000', range=[0, 400000], row=2, col=4)

    fig.update_xaxes(gridcolor='lightgrey', row=1, col=2, dtick=15 * 60 * 1000)
    fig.update_xaxes(gridcolor='lightgrey', row=1, col=3, dtick=15 * 60 * 1000)
    fig.update_xaxes(gridcolor='lightgrey', row=1, col=4, dtick=15 * 60 * 1000)
    ...
    fig.update_layout(title_text=Ticker, xaxis1_rangeslider_visible=True, xaxis2_rangeslider_visible=True,
                      ...
                      height=1300, width=2500, showlegend=False)
